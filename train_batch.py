...
if __name__ == "__main__":
    ...
    dataset_root = config.scene.scene_path
    ...
    for scene in scene_list:
        ...
        if os.path.isdir(scene_path):
            config_copy.scene.scene_path = scene_path
            config_copy.train.exp_name = config.train.exp_name + "/" + scene
            print(OmegaConf.to_yaml(config_copy))

            set_seed(config_copy.pipeline.seed)
            train(config_copy)
            torch.cuda.empty_cache()
